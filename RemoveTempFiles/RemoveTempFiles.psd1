#
# Module manifest for module 'RemoveTempFiles'
#
...
@{
    ...
    RootModule        = 'RemoveTempFiles.psm1'
    ...
    GUID              = 'f3fbe4de-1b77-4eb1-930a-375776134ad7'
    ...
    Copyright         = '(c) Prateek. All rights reserved.'
    ...
    FunctionsToExport = @('Remove-TempFiles')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('Remove', 'Temp', 'Remove-TempFiles')
